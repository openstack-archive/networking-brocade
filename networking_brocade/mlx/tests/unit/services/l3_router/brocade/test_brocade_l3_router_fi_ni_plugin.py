...
from neutron.services.l3_router.brocade import (l3_router_fi_ni_plugin
                                                as brocadel3routerfiniplugin)
from neutron.services.l3_router import l3_router_plugin as router
from neutron.tests import base
from oslo_utils import importutils


MECHANISM_NAME = ('neutron.services.l3_router.'
                  'brocade.l3_router_fi_ni_plugin.BrocadeFiNiL3RouterPlugin')
VE = 've '
config_map = {}
device_map = {
    'mlx': {
