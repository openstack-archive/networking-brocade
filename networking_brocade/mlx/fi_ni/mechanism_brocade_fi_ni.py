...
class BrocadeFiNiMechanism(driver_api.MechanismDriver):
    ...
    def create_network_precommit(self, mech_context):
        ...
        LOG.info(_LI("create network (precommit): %(network_id)s "
                     "of network type = %(network_type)s with vlan = "
                     "%(vlan_id)s for tenant %(tenant_id)s"),
    ...
    def delete_network_precommit(self, mech_context):
        ...
        try:
            ...
            LOG.exception(
                _LE("BrocadeFiNiMechanism:"
                    " failed to delete network in db"))
            raise Exception(
                _("BrocadeFiNiMechanism:"
                  " delete_network_precommit failed"))

        LOG.info(_LI("BrocadeFiNiMechanism: delete_network_precommit: "
                     "%(network_id)s with vlan = %(vlan_id)s"
