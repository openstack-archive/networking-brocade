        ...
        <rbridge-id xmlns="urn:brocade.com:mgmt:brocade-rbridge">
		    ...
		    <ip xmlns="urn:brocade.com:mgmt:brocade-vrf">
			    ...
			    <ip xmlns="urn:brocade.com:mgmt:brocade-rtm">
				    ...
				    <static-route-nh operation="delete" xmlns="urn:brocade.com:mgmt:brocade-rtm">
				        <static-route-dest>{destination_ip}</static-route-dest>
				        <static-route-next-hop>{next_hop}</static-route-next-hop>
				    </static-route-nh>
			        </route>
    ...
    <config xmlns:xc="urn:ietf:params:xml:ns:netconf:base:1.0">
	    ...
	    <ip xmlns="urn:brocade.com:mgmt:brocade-rbridge">
                <rtm-config xmlns="urn:brocade.com:mgmt:brocade-rtm">
                    <route xmlns="urn:brocade.com:mgmt:brocade-rtm">
                        <static-route-nh xmlns="urn:brocade.com:mgmt:brocade-rtm">
                            <static-route-dest>{destination_ip}</static-route-dest>
                            <static-route-next-hop>{next_hop}</static-route-next-hop>
                        </static-route-nh>
                    </route>
...
INTERFACE_PP_STATUS_XPATH_FILTER = "/interface/{speed}[name='{name}']/*[local-"\
    "name()='port-profile-port']"
INTERFACE_CG_STATUS_XPATH_FILTER = "/interface/{speed}[name='{name}']/*[local-"\
    "name()='channnel-group']"
